...
(
			...
			`LegalFormCodeText`                          varchar(80) DEFAULT NULL,
			...
			`NielsenRegionCodeText`                      varchar(80) DEFAULT NULL,
			`IndustrialSectorCode`                       varchar(10) DEFAULT NULL,
			`IndustrialSectorCodeText`                   varchar(80) DEFAULT NULL,
            ...
            `POBoxIndicator`                             varchar(80) DEFAULT NULL,
            ...
            `POBoxDeviatingRegionCodeText`               varchar(80) DEFAULT NULL,
