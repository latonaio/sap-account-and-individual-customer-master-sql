CREATE TABLE `sap-contact-collection-data`
(
			...
			'AdditionalAcademicTitleCodeText'       varchar(80) DEFAULT NULL,
			'NamePrefixCode'                        varchar(4) DEFAULT NULL,
			'NamePrefixCodeText'                    varchar(80) DEFAULT NULL,
			...
			'ProfessionCodeText'                    varchar(80) DEFAULT NULL,
			'PerceptionOfCompanyCode'               varchar(2) DEFAULT NULL,
			'PerceptionOfCompanyCodeText'           varchar(80) DEFAULT NULL,
			...
			'EmailInvalidIndicator'                 varchar(80) DEFAULT NULL,
			...
			'BusinessAddressCountryCodeText'        varchar(80) DEFAULT NULL,
			...
			'EntityLastChangedOn'                   varchar(40) DEFAULT NULL,
			'ETag'                                  varchar(80) DEFAULT NULL,
    PRIMARY KEY (`ContactID`),
    CONSTRAINT `SapContactCollectionData` FOREIGN KEY (`ContactID`) REFERENCES `sap-contact-collection-data` (`ContactID`)
) ENGINE = InnoDB
